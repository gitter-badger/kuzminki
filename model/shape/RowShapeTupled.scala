...
class RowShape2[R1, R2](
  ...
  def conv = {
    shape match {
      case (col1, col2) => 
        RowConv2(Tuple2(col1.conv, col2.conv))
    }
  }
...
class RowShape3[R1, R2, R3](
  ...
  def conv = {
    shape match {
      case (col1, col2, col3) => 
        RowConv3(Tuple3(col1.conv, col2.conv, col3.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4) => 
        RowConv4(Tuple4(col1.conv, col2.conv, col3.conv, col4.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5) => 
        RowConv5(Tuple5(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6) => 
        RowConv6(Tuple6(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7) => 
        RowConv7(Tuple7(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8) => 
        RowConv8(Tuple8(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9) => 
        RowConv9(Tuple9(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10) => 
        RowConv10(Tuple10(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11) => 
        RowConv11(Tuple11(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12) => 
        RowConv12(Tuple12(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13) => 
        RowConv13(Tuple13(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14) => 
        RowConv14(Tuple14(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15) => 
        RowConv15(Tuple15(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16) => 
        RowConv16(Tuple16(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17) => 
        RowConv17(Tuple17(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18) => 
        RowConv18(Tuple18(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv, col18.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19) => 
        RowConv19(Tuple19(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv, col18.conv, col19.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20) => 
        RowConv20(Tuple20(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv, col18.conv, col19.conv, col20.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20, col21) => 
        RowConv21(Tuple21(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv, col18.conv, col19.conv, col20.conv, col21.conv))
    }
  }
  ...
  def conv = {
    shape match {
      case (col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20, col21, col22) => 
        RowConv22(Tuple22(col1.conv, col2.conv, col3.conv, col4.conv, col5.conv, col6.conv, col7.conv, col8.conv, col9.conv, col10.conv, col11.conv, col12.conv, col13.conv, col14.conv, col15.conv, col16.conv, col17.conv, col18.conv, col19.conv, col20.conv, col21.conv, col22.conv))
    }
  }
